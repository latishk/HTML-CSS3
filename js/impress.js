...
(function ( document, window ) {
    ...
    var impress = window.impress = function ( rootId ) {
        ...
        var getStep = function ( step ) {
            ...
            /*var temp = step.getAttribute("data-transition-duration");
            if(temp != null)
                config.transitionDuration = parseInt(temp);
            else
                config.transitionDuration = config.transitionDurationReset; */
